...
export function createBlack() {
    let sphere = new SphereGeometry(8, 40, 40);
    //   let sphere = new SphereGeometry(5, 40, 40)
    let blackMaterial = new MeshBasicMaterial({ color: 0x000000 });
    //   let blackMaterial = new MeshBasicMaterial({ opacity: 1,transparent: true})
    //   let blackMaterial = new MeshBasicMaterial({ color: sunColor, opacity: 0, transparent: true })
...
export function createGlow() {
    let sphere = new SphereGeometry(6, 40, 40);
    //   let sphere = new SphereGeometry(5, 40, 40)
